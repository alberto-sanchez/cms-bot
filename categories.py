...
TRIGGER_PR_TESTS = list(set([ "lgray", "bsunanda", "VinInn", "kpedro88", "makortel", "davidlt", "wddgit", "mtosi", "gpetruc", "alberto-sanchez"] + REQUEST_BUILD_RELEASE + [ a for a in authors if authors[a]>10 and not a in GITHUB_BLACKLIST_AUTHORS ]))
...
CMSSW_CATEGORIES={
 ...
 "analysis": [
  ...
  "generators": [
   ...
   "GeneratorInterface/ThePEGInterface","GeneratorInterface/Herwig7Interface",
